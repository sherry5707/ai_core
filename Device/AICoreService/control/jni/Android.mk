...
LOCAL_SRC_FILES :=../inlibs/$(TARGET_ARCH_ABI)/libCtrlModule.so
include $(PREBUILT_SHARED_LIBRARY)

#include $(CLEAR_VARS)
#LOCAL_MODULE := libtencentECC
#LOCAL_SRC_FILES :=../inlibs/$(TARGET_ARCH_ABI)/libtencentECC.so
#include $(PREBUILT_SHARED_LIBRARY)
...
APP_CPPFLAGS += -fexceptions -g -pthread;

#LOCAL_LDFLAGS += $(LOCAL_PATH)/../../../CtrlModule/out/$(TARGET_ARCH_ABI)/libCtrlModule.so
LOCAL_LDFLAGS += $(LOCAL_PATH)/../inlibs/$(TARGET_ARCH_ABI)/libCtrlModule.so
LOCAL_LDFLAGS += $(LOCAL_PATH)/../../../../DeviceSDK/release/Android/$(TARGET_ARCH_ABI)/libxiaoweiSDK.so
#LOCAL_LDFLAGS += $(LOCAL_PATH)/lib/libssl.so
#LOCAL_LDFLAGS += $(LOCAL_PATH)/lib/libcrypto.so
#LOCAL_LDFLAGS += $(LOCAL_PATH)/../inlibs/$(TARGET_ARCH_ABI)/libtencentECC.so
LOCAL_LDFLAGS += -llog
