...
public interface IXWeiPlayer {
    ...
    // szjy begins
    int IXW_PARAM_TYPE_BASE = 0;
    int IXW_PARAM_TYPE_TTS_CB = IXW_PARAM_TYPE_BASE + 1;
    int IXW_PARAM_TYPE_NOTIFY_CB = IXW_PARAM_TYPE_BASE + 2;

    int IXW_PLAYER_CMD_TYPE_BASE = 0;
    int IXW_PLAYER_CMD_TYPE_DUMP = IXW_PLAYER_CMD_TYPE_BASE + 1;

    void setParam(int paramType, Object param);

    Object handleCmd(int cmd, int intParam1, int intParam2,
                     String strParam1, String strParam2, Object objParam1, Object objParam);
    // szjy end
}
