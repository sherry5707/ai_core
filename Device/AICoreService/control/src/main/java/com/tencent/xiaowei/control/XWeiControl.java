...
public class XWeiControl {
    ...
    //szjy begin
    public boolean playMedia(XWeiMediaInfo mediaInfo, boolean needReleaseRes, ITTSCallback cb) {
        QAILog.d(TAG, "playMedia() called with: mediaInfo = [" + mediaInfo + "], needReleaseRes = [" + needReleaseRes + "]");
        return getXWeiPlayerMgr() != null && getXWeiPlayerMgr().playTTS(mediaInfo, needReleaseRes, cb);
    }
    //szjy end
